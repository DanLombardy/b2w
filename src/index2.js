...
PhaserGame.prototype = {
  ...
  preload: function () {
    ...
    this.load.image('trees', 'assets/sprites/trees-h.png');
    this.load.image('background', 'assets/sprites/clouds-h.png');
    this.load.image('platform', 'assets/sprites/platform1.png');
...
CloudPlatform.prototype.win = function () {
  winText = this.add.text(16, 16, '', { fontSize: '32px', fill: '#000' });
